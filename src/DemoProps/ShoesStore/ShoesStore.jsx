...
export default class ShoesStore extends Component {
    ...
    render() {
        // let { name, image } = this.state.productDetail;
        return (
            <div className='container'>
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <h1>Shoes Shop</h1>
                        <ProductList renderDetail={this.renderDetail}   shoesArray={this.shoesArray} />
                    </div>
                </div>

                <ProductModal  productDetail={this.state.productDetail} />
